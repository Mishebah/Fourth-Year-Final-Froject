...
$dob=$_POST['dob']; 
$status=1;
$sql="INSERT INTO  tblstudents(StudentName,RollId,NtnalId,PhoneNumber,StudentEmail,Gender,ClassId,DOB,Status) VALUES(:studentname,:roolid,:id_num,:studentphone,:studentemail,:gender,:classid,:dob,:status)";
...
<div class="col-sm-10">
<input type="text" name="id_num" class="form-control" id="id_num" maxlength="10" required="required" autocomplete="off">
</div>
</div>
